(define (problem RTAM_6_3_40) (:domain RTAM)
(:objects
accident0 accident1 accident2 accident3 accident4 accident5 - accident
accident_location0 accident_location1 accident_location2 accident_location3 accident_location4 accident_location5 - accident_location
acc_victim0 acc_victim1 acc_victim2 acc_victim3 acc_victim4 acc_victim5 acc_victim6 acc_victim7 acc_victim8 acc_victim9 acc_victim10 acc_victim11 acc_victim12 acc_victim13 acc_victim14 acc_victim15 acc_victim16 acc_victim17 acc_victim18 acc_victim19 acc_victim20 acc_victim21 acc_victim22 acc_victim23 acc_victim24 acc_victim25 acc_victim26 acc_victim27 acc_victim28 acc_victim29 acc_victim30 acc_victim31 acc_victim32 acc_victim33 acc_victim34 acc_victim35 acc_victim36 acc_victim37 acc_victim38 acc_victim39 - acc_victim
...
(= (route-length bradley_ainley) 6)
(= (route-length hud_brigh) 5)
(= (route-length a629) 10)
(= (route-length ainley_greet) 10)
(= (route-length ainley_brigh) 2)
(= (route-length greet_halifax) 8)
(= (route-length brigh_baliff) 8)
(= (route-length brigh_queen) 10)
(= (route-length baliff_halifax) 2)
(= (route-length queen_halifax) 4)
(= (route-length ainley_halifax) 9)
(at acc_victim0 accident_location1)
(uncertified acc_victim0)
(trapped acc_victim0)
(at acc_victim1 accident_location3)
...
(at acc_victim3 accident_location3)
...
(at acc_victim13 accident_location3)
...
(at acc_victim16 accident_location0)
...
(at acc_victim18 accident_location2)
...
(at acc_victim23 accident_location2)
...
(at acc_victim26 accident_location2)
(uncertified acc_victim26)
(untrapped acc_victim26)
(at acc_victim27 accident_location4)
(uncertified acc_victim27)
(untrapped acc_victim27)
(at acc_victim28 accident_location2)
(uncertified acc_victim28)
(trapped acc_victim28)
(at acc_victim29 accident_location0)
...
(at acc_victim31 accident_location5)
(uncertified acc_victim31)
(trapped acc_victim31)
(at acc_victim32 accident_location0)
...
(at acc_victim34 accident_location2)
(uncertified acc_victim34)
(trapped acc_victim34)
(at acc_victim35 accident_location1)
...
(at acc_victim37 accident_location4)
...
(uncertified car0)
(off_fire car0)
(at car1 accident_location2)
(uncertified car1)
(off_fire car1)
(at car2 accident_location5)
(uncertified car2)
(on_fire car2)
(at car3 accident_location5)
(uncertified car3)
(on_fire car3)
(at car4 accident_location0)
(uncertified car4)
(on_fire car4)
(at car5 accident_location0)
(uncertified car5)
(on_fire car5)
(at car6 accident_location5)
(uncertified car6)
(on_fire car6)
(at car7 accident_location4)
(uncertified car7)
(off_fire car7)
(at car8 accident_location0)
(uncertified car8)
(off_fire car8)
(at car9 accident_location5)
(uncertified car9)
(off_fire car9)
(at car10 accident_location3)
(uncertified car10)
(off_fire car10)
(at car11 accident_location4)
(uncertified car11)
(off_fire car11)
(at car12 accident_location1)
(uncertified car12)
(off_fire car12)
(at car13 accident_location4)
(uncertified car13)
(off_fire car13)
(at car14 accident_location5)
(uncertified car14)
(off_fire car14)
...
(uncertified car16)
(off_fire car16)
(at car17 accident_location5)
(uncertified car17)
(off_fire car17)
(at car18 accident_location1)
(uncertified car18)
(off_fire car18)
(at car19 accident_location3)
(uncertified car19)
(off_fire car19)
(at car20 accident_location1)
(uncertified car20)
(off_fire car20)
(at car21 accident_location1)
(uncertified car21)
(on_fire car21)
(at car22 accident_location1)
(uncertified car22)
(on_fire car22)
(at car23 accident_location1)
(uncertified car23)
(off_fire car23)
(at car24 accident_location5)
(uncertified car24)
(off_fire car24)
(at car25 accident_location0)
(uncertified car25)
(off_fire car25)
(at car26 accident_location2)
(uncertified car26)
(off_fire car26)
(at car27 accident_location5)
(uncertified car27)
(on_fire car27)
(at car28 accident_location3)
(uncertified car28)
(on_fire car28)
(at car29 accident_location3)
(uncertified car29)
(off_fire car29)
(at car30 accident_location1)
(uncertified car30)
(on_fire car30)
(at car31 accident_location5)
(uncertified car31)
(off_fire car31)
(at car32 accident_location2)
(uncertified car32)
(off_fire car32)
